...
The format should be roomId:reconnectionToken`);return yield this.createMatchMakeRequest("reconnect",p,{reconnectionToken:g},u)})}consumeSeatReservation(f,u,p){return n.__awaiter(this,void 0,void 0,function*(){const g=this.createRoom(f.room.name,u);g.roomId=f.room.roomId,g.sessionId=f.sessionId;const y={sessionId:g.sessionId};f.reconnectionToken&&(y.reconnectionToken=f.reconnectionToken);const x=p||g;return g.connect(this.buildEndpoint(f.room,y,f.protocol),f.devMode&&(()=>n.__awaiter(this,void 0,void 0,function*(){console.info(`[Colyseus devMode]: ${String.fromCodePoint(128260)} Re-establishing connection with room id '${g.roomId}'...`);let _=0,T=8;const P=()=>n.__awaiter(this,void 0,void 0,function*(){_++;try{yield this.consumeSeatReservation(f,u,x),console.info(`[Colyseus devMode]: ${String.fromCodePoint(9989)} Successfully re-established connection with room '${g.roomId}'`)}catch{_<T?(console.info(`[Colyseus devMode]: ${String.fromCodePoint(128260)} retrying... (${_} out of ${T})`),setTimeout(P,2e3)):console.info(`[Colyseus devMode]: ${String.fromCodePoint(10060)} Failed to reconnect. Is your server running? Please check server logs.`)}});setTimeout(P,2e3)})),x,f,this.http.headers),new Promise((_,T)=>{const P=(M,I)=>T(new e.ServerError(M,I));x.onError.once(P),x.onJoin.once(()=>{x.onError.remove(P),_(x)})})})}createMatchMakeRequest(f,u){return n.__awaiter(this,arguments,void 0,function*(p,g,y={},x,_){const T=(yield this.http.post(`matchmake/${p}/${g}`,{headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(y)})).data;if(T.error)throw new o(T.error,T.code);return p==="reconnect"&&(T.reconnectionToken=y.reconnectionToken),yield this.consumeSeatReservation(T,x,_)})}createRoom(f,u){return new t.Room(f,u)}buildEndpoint(f,u={},p="ws"){let g=this.settings.searchParams||"";this.http.authToken&&(u._authToken=this.http.authToken);for(const _ in u)u.hasOwnProperty(_)&&(g+=(g?"&":"")+`${_}=${u[_]}`);p==="h3"&&(p="http");let y=this.settings.secure?`${p}s://`:`${p}://`;f.publicAddress?y+=`${f.publicAddress}`:y+=`${this.settings.hostname}${this.getEndpointPort()}${this.settings.pathname}`;const x=`${y}/${f.processId}/${f.roomId}?${g}`;return this.urlBuilder?this.urlBuilder(new URL(x)):x}getHttpEndpoint(f=""){const u=f.startsWith("/")?f:`/${f}`;let p=`${this.settings.secure?"https":"http"}://${this.settings.hostname}${this.getEndpointPort()}${this.settings.pathname}${u}`;return this.settings.searchParams&&(p+=`?${this.settings.searchParams}`),this.urlBuilder?this.urlBuilder(new URL(p)):p}getEndpointPort(){return this.settings.port!==80&&this.settings.port!==443?`:${this.settings.port}`:""}};return l.VERSION="0.16.22",Xo.Client=l,Xo.MatchMakeError=o,Xo}var Af={},Km;function MC(){if(Km)return Af;Km=1;let n=class{setState(t){}getState(){return null}patch(t){}teardown(){}handshake(t){}};return Af.NoneSerializer=n,Af}var Zm;function EC(){return Zm||(Zm=1,(function(n){mR();var e=SC(),t=l_(),i=R_(),r=C_(),s=pc(),a=u_(),o=MC(),c=c_();c.registerSerializer("schema",a.SchemaSerializer),c.registerSerializer("none",o.NoneSerializer),n.Client=e.Client,n.MatchMakeError=e.MatchMakeError,Object.defineProperty(n,"ErrorCode",{enumerable:!0,get:function(){return t.ErrorCode}}),Object.defineProperty(n,"Protocol",{enumerable:!0,get:function(){return t.Protocol}}),n.Room=i.Room,n.Auth=r.Auth,n.ServerError=s.ServerError,n.SchemaSerializer=a.SchemaSerializer,n.getStateCallbacks=a.getStateCallbacks,n.registerSerializer=c.registerSerializer})(pf)),pf}var bC=EC();const wC={},TC=wC.VITE_SERVER_URL??`ws://${location.hostname}:${wb}`;async function AC(n,e){const t=new bC.Client(TC),i=e===null?await t.create("race",{nickname:n,code:i1()}):await t.join("race",{nickname:n,code:e.toUpperCase()});return{room:i,sessionId:i.sessionId,isHost:()=>i.state.hostSessionId===i.sessionId,sendInput:r=>i.send("input",r),start:()=>i.send("start",{})}}const P_="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(11,16,38,.85);color:#fff;font:16px system-ui;z-index:10",I_="background:#141b3d;padding:28px 32px;border-radius:16px;min-width:320px;display:flex;flex-direction:column;gap:12px",ul="padding:10px 16px;border:none;border-radius:10px;background:#e84d3d;color:#fff;font:600 16px system-ui;cursor:pointer";let $n=null;const RC=()=>["localhost","127.0.0.1"].includes(location.hostname);function CC(n,e){var c;const t=RC(),i=t?"":"disabled";$n=document.createElement("div"),$n.style.cssText=P_;const r=document.createElement("div");if(r.style.cssText=I_,r.innerHTML=`
    ...
    <button id="practice" style="${ul};background:#2fbf71">Practice (solo) — no server needed</button>`,$n.appendChild(r),document.body.appendChild($n),!t){const l=r.querySelector("#mp");l.style.opacity="0.35";for(const h of l.querySelectorAll("button, input"))h.style.cursor="not-allowed"}const s=r.querySelector("#nick"),a=r.querySelector("#code"),o=(c=/^\/r\/([A-Za-z0-9]{4})$/.exec(location.pathname))==null?void 0:c[1];o&&(a.value=o.toUpperCase()),r.querySelector("#create").addEventListener("click",()=>{n(s.value||"Pilot",null)}),r.querySelector("#join").addEventListener("click",()=>{a.value.length===4&&n(s.value||"Pilot",a.value)}),r.querySelector("#practice").addEventListener("click",()=>{e()})}function PC(n,e,t){var a;$n||($n=document.createElement("div"),$n.style.cssText=P_,document.body.appendChild($n));const i=n.hostSessionId===e,r=[];n.players.forEach(o=>r.push(o.nickname));const s=`${location.origin}/r/${n.code}`;$n.innerHTML=`
    <div style="${I_}">
    ...
    </div>`,(a=$n.querySelector("#go"))==null||a.addEventListener("click",t)}function Jm(){$n==null||$n.remove(),$n=null}const IC="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(11,16,38,.85);color:#fff;font:16px system-ui;z-index:10",DC="background:#141b3d;padding:28px 32px;border-radius:16px;min-width:360px;display:flex;flex-direction:column;gap:14px",jo="padding:10px 16px;border:none;border-radius:10px;background:#2fbf71;color:#fff;font:600 16px system-ui;cursor:pointer",Ma="flex:1;padding:8px 4px;border:none;border-radius:8px;font:600 13px system-ui;cursor:pointer";let vi=null;function LC(n,e){vi==null||vi.remove(),vi=document.createElement("div"),vi.style.cssText=IC;const t=document.createElement("div");t.style.cssText=DC;const i=Object.keys(Cs).map(u=>`<button data-plane="${u}" title="${Cs[u].blurb}" style="${Ma}">${Cs[u].emoji}<br>${Cs[u].name}</button>`).join("");t.innerHTML=`
    ...
    <div style="display:flex;gap:8px">
      ...
      </tr>`}).join(""),a=i!==null?n.totalS<=i?'<div style="color:#2fbf71;font-weight:700">🎉 New best time!</div>':`<div style="opacity:.8">Best: ${hl(i)}</div>`:"",o=document.createElement("div");o.style.cssText=kC,o.innerHTML=`
    ...
    <button data-menu style="${Qm};background:#3d6ee8">Menu</button>`,yi.appendChild(o),document.body.appendChild(yi),o.querySelector("[data-again]").addEventListener("click",()=>{e0(),r.onNewContract()}),o.querySelector("[data-menu]").addEventListener("click",()=>{e0(),r.onMenu()})}function e0(){yi==null||yi.remove(),yi=null}const D_="cargoSkies.passport.v1";function L_(){try{return JSON.parse(localStorage.getItem(D_)??"{}")}catch{return{}}}function HC(n){const e=L_(),t=[];for(const i of n)e[i]||t.push(i),e[i]=(e[i]??0)+1;return localStorage.setItem(D_,JSON.stringify(e)),t}const GC="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(11,16,38,.85);color:#fff;font:16px system-ui;z-index:11";let ii=null;function WC(n,e){ii==null||ii.remove();const t=L_(),i=Object.entries(t).map(([a,o])=>({meta:n[a],count:o})).filter(a=>a.meta!==void 0).sort((a,o)=>a.meta.name.localeCompare(o.meta.name)),r=Object.values(n).filter(a=>a.playable).length;ii=document.createElement("div"),ii.style.cssText=GC;const s=i.map(a=>`<div style="display:flex;gap:8px;align-items:center;padding:4px 8px;background:rgba(255,255,255,.06);border-radius:8px">
    ...
    </div>`,document.body.appendChild(ii),ii.querySelector("[data-close]").addEventListener("click",()=>{ii==null||ii.remove(),ii=null})}const ih=.1,N_=(n,e,t)=>`cargoSkies.trial.v2.${n}.${e}.${t}`,$C=(n,e)=>n.charCodeAt(0)*7919+e*104729>>>0;function t0(n,e,t){try{const i=localStorage.getItem(N_(n,e,t));return i?JSON.parse(i):null}catch{return null}}function XC(n,e,t,i){localStorage.setItem(N_(n,e,t),JSON.stringify(i))}const n0=n=>new X(n.x,n.y,n.z);function qC(n){const e=jl(16777215);e.traverse(i=>{i instanceof Bt&&i.material instanceof ns&&(i.material=i.material.clone(),i.material.transparent=!0,i.material.opacity=.35)}),e.visible=!1,n.add(e);let t=[];return{start(i){t=i,e.visible=t.length>0},stop(){t=[],e.visible=!1},update(i){if(t.length===0)return;const r=i/ih,s=Math.min(t.length-1,Math.floor(r)),a=t[Math.min(t.length-1,s+1)],o=t[s],c=Math.min(1,r-s),l=o.lat+(a.lat-o.lat)*c,h=(a.lon-o.lon+540)%360-180,f=(o.lon+h*c+540)%360-180,u=o.altKm+(a.altKm-o.altKm)*c,p=n0(Cr(l,f,u)),g=fc(l,f,o.headingDeg,5);e.position.copy(p),e.up.copy(p.clone().normalize()),e.lookAt(n0(Cr(g.lat,g.lon,u)))}}}const YC=34,KC=.004;function ZC(){const n=new fi,e=new Vs({color:CA,gradientMap:Ya(),transparent:!0,opacity:.92});for(let t=0;t<YC;t++){const i=new fi,r=3+Math.floor(Math.random()*3);for(let l=0;l<r;l++){const h=1.2+Math.random()*1.6,f=new Bt(new is(h,10,8),e);f.position.set((l-r/2)*1.6,(Math.random()-.5)*.6,(Math.random()-.5)*1.4),f.scale.y=.6,i.add(f)}const s=(Math.random()-.5)*140,a=Math.random()*360-180,o=260+Math.random()*160,c=Cr(s,a,o);i.position.set(c.x,c.y,c.z),i.lookAt(0,0,0),n.add(i)}return{group:n,update(t){n.rotation.y+=KC*t}}}const JC=12,jC=30,QC=.8,e2=1.2;function t2(n,e){const t=Math.max(0,n),i=JC+e*QC,r=jC+e*e2;return t<=i?1:t>=r?0:1-(t-i)/(r-i)}const Si=Math.PI/180,Ca=512,dl=96,n2=5,i2=26,r2=.7,s2="#24365e",a2="rgba(255,255,255,0.85)";function o2(n){const e=document.createElement("canvas");e.width=Ca,e.height=dl;const t=e.getContext("2d");if(!t)throw new Error("2d canvas unavailable");let i=56;const r=()=>{t.font=`bold ${i}px 'Trebuchet MS', Verdana, sans-serif`};for(r();t.measureText(n).width>Ca-24&&i>18;)i-=4,r();t.textAlign="center",t.textBaseline="middle",t.lineWidth=8,t.lineJoin="round",t.strokeStyle=a2,t.strokeText(n,Ca/2,dl/2),t.fillStyle=s2,t.fillText(n,Ca/2,dl/2);const s=new P0(e);return s.anisotropy=4,s}function l2(n,e,t,i){const r=Math.max(1.5,t*Math.cos(n*Si)*(dl/Ca)),s=new is(AA,12,4,(90+e-t/2)*Si,t*Si,(90-n-r/2)*Si,r*Si),a=new Za({map:i,transparent:!0,opacity:0,depthWrite:!1});return new Bt(s,a)}function c2(n){const e=new fi,t=[];for(const r of n.features){if(r.properties.id==="ATA")continue;const s=Jb(r.geometry),a=Math.min(i2,Math.max(n2,s.widthDeg*r2)),o=l2(s.lat,s.lon,a,o2(r.properties.name));o.visible=!1,e.add(o),t.push({mesh:o,widthDeg:a,direction:new X(Math.cos(s.lat*Si)*Math.sin(s.lon*Si),Math.sin(s.lat*Si),Math.cos(s.lat*Si)*Math.cos(s.lon*Si))})}const i=new X;return{group:e,update(r){i.copy(r.position).normalize();for(const s of t){const a=Math.acos(v0.clamp(i.dot(s.direction),-1,1))/Si,o=t2(a,s.widthDeg);s.mesh.visible=o>.02,s.mesh.material.opacity=o}}}}const ri=1/60,f2=.25,u2=1/20;async function h2(){var Qe;const n=document.getElementById("app");if(!n)throw new Error("#app root missing");const{world:e,countries:t,landmarks:i,riddles:r}=await FA(),s=Kb(e),{scene:a,camera:o,renderer:c}=UA(n),l=NA(e);a.add(l.group);const h=c2(e);a.add(h.group);const f=ZC();a.add(f.group);let u=jl();a.add(u);let p=Eh,g=G0;const y=(Ae,Ve=15224125)=>{a.remove(u),u=jl(Ve,Ae),a.add(u),p=Cs[Ae].tuning,_=hm(u,o)},x=zA();let _=hm(u,o);const T=eR(document.body),P=tR(a),M=iR(a),I=fR(a),R=new X(0,.2,-2.2),O=.3,S=uR(document.body),w=pR(document.body),B=BC(l);let N=Qb();const z=Ae=>{N=Ae},L=qC(a);let k=null,A=!1,U=[],F=0,G=0;const Z=()=>{LC(te,()=>{WC(t)})},te=Ae=>{if(NC(),k=Ae,y(Ae.plane),g=Su[Ae.speed].worldSpeedScale,A=Ae.mode==="trial",L.stop(),U=[],F=0,G=0,Ae.mode==="contract")ue.startContract({difficulty:Ae.difficulty,legCount:Ae.legCount});else if(Ae.mode==="trial"){const Ve=$C(Ae.difficulty,Ae.legCount),tt=t0(Ae.difficulty,Ae.legCount,Ae.speed);tt&&L.start(tt.track),ue.startContract({difficulty:Ae.difficulty,legCount:Ae.legCount,seed:Ve})}},ue=UC({countries:t,landmarks:i,riddles:r,banner:w,hints:B,beacon:M,onContractComplete:Ae=>{w.setClock(null);const Ve=HC(Ae.contract.legs.map(qe=>qe.countryId));let tt=null;if(A&&k){const qe=t0(k.difficulty,k.legCount,k.speed);tt=(qe==null?void 0:qe.timeS)??Ae.totalS,(!qe||Ae.totalS<qe.timeS)&&XC(k.difficulty,k.legCount,k.speed,{timeS:Ae.totalS,track:U}),L.stop()}VC(Ae,t,Ve,tt,{onNewContract:()=>{k&&te(k)},onMenu:Z})}}),pe=await new Promise(Ae=>{CC((Ve,tt)=>{AC(Ve,tt).then(Ae).catch(qe=>{console.error("Connection failed",qe);const vt=String((qe==null?void 0:qe.message)??qe),gt=/ECONNREFUSED|failed to connect|WebSocket|network|refused/i.test(vt);alert(gt?"Can't reach the game server. Is it running? (pnpm dev:server)":tt!==null?`No race found with code ${tt.toUpperCase()}. Check the code and try again.`:"Couldn't start a race — see the console for details.")})},()=>Ae(null))});if(pe===null)Jm(),Z();else{history.replaceState(null,"",`/r/${pe.room.state.code||""}`);const Ae=((Qe=pe.room.state.players.get(pe.sessionId))==null?void 0:Qe.colorIdx)??0;u.traverse(tt=>{tt instanceof Bt&&tt.material instanceof Vs&&tt.material.color.getHex()===15224125&&tt.material.color.setHex(Jl[Ae%Jl.length]??15224125)});let Ve=!0;pe.room.onStateChange(tt=>{if(tt.phase==="lobby"&&Ve?PC(tt,pe.sessionId,()=>pe.start()):Ve&&(Jm(),Ve=!1),P.sync(tt,pe.sessionId),S.update(tt,pe.sessionId),(tt.phase==="countdown"||tt.phase==="racing")&&tt.targetCountryId){const vt=t[tt.targetCountryId];vt&&M.showAt(vt.capital.lat,vt.capital.lon)}else M.hide();const qe=tt.players.get(pe.sessionId);qe&&Sl(qe.lat,qe.lon,N.lat,N.lon)>Ab&&z({lat:qe.lat,lon:qe.lon,altKm:qe.altKm,headingDeg:qe.headingDeg,speedKmh:qe.speedKmh})})}let ze=0,at=0,et=0,he=0,be={throttle:0,turn:0,pitch:0};const ve=new vv;c.setAnimationLoop(()=>{var Ve;for(ve.update(),ze+=Math.min(ve.getDelta(),.25);ze>=ri;)be=x.read(ri),N=e1(N,be,ri,p,g),ue.isActive()&&(ue.update(N,ri),A&&(G+=ri,F+=ri,F>=ih&&(F-=ih,U.push({lat:N.lat,lon:N.lon,altKm:N.altKm,headingDeg:N.headingDeg})))),ze-=ri,at+=ri,et+=ri;if(pe&&et>=u2&&(et=0,pe.sendInput(be)),at>=f2){at=0;const tt=s.findCountryAt(N.lat,N.lon);T.setCountry(tt?((Ve=t[tt])==null?void 0:Ve.name)??tt:null)}he+=ri,_.update(N,be),h.update(o),B.update(he),M.update(he),f.update(ri);const Ae=(N.speedKmh-Fa)/(Mh-Fa);I.update(ri,u.localToWorld(R.clone()),Ae>O),L.update(G),pe&&P.update(),T.setTelemetry(N),c.render(a,o)})}h2().catch(n=>{console.error("Failed to start Cargo Skies",n),document.body.textContent="Engine stalled — please refresh."});
