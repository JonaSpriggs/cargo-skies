...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function QM(n,e,t){const i=new Float32Array(Xr),r=new W(0,1,0);return new hi({name:"SphericalGaussianBlur",defines:{n:Xr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:bc(),fragmentShader:`
...
`].filter(Oo).join(`
`)),o=Bu(o),o=mp(o,t),o=gp(o,t),a=Bu(a),a=mp(a,t),a=gp(a,t),o=_p(o),a=_p(a),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`})}return ee(w),!g&&y.filteredChanges&&y.filteredChanges.operations.filter(Q=>Q).length>0&&(X+=`${d.constructor.name} (${y.refId}) -> .filteredChanges:
...
`,ee(y.allFilteredChanges)),X}static debugChangesDeep(d,g="changes"){var pe,de;let y="";const w=d[f],V=w.root,X=new Map,ee=[];let Q=0;for(const[ge,Be]of Object.entries(V[g])){const He=V.changeTrees[ge];if(!He)continue;let Ae=!1,ye=[],$e=(pe=He.parent)==null?void 0:pe[f];if(He===w)Ae=!0;else for(;$e!==void 0;){if(ye.push($e),$e.ref===d){Ae=!0;break}$e=(de=$e.parent)==null?void 0:de[f]}Ae&&(ee.push(He.refId),Q+=Object.keys(Be).length,X.set(He,ye.reverse()))}y+=`---
