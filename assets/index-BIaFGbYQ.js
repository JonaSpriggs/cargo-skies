...
The format should be roomId:reconnectionToken`);return yield this.createMatchMakeRequest("reconnect",p,{reconnectionToken:m},u)})}consumeSeatReservation(f,u,p){return n.__awaiter(this,void 0,void 0,function*(){const m=this.createRoom(f.room.name,u);m.roomId=f.room.roomId,m.sessionId=f.sessionId;const v={sessionId:m.sessionId};f.reconnectionToken&&(v.reconnectionToken=f.reconnectionToken);const _=p||m;return m.connect(this.buildEndpoint(f.room,v,f.protocol),f.devMode&&(()=>n.__awaiter(this,void 0,void 0,function*(){console.info(`[Colyseus devMode]: ${String.fromCodePoint(128260)} Re-establishing connection with room id '${m.roomId}'...`);let x=0,T=8;const R=()=>n.__awaiter(this,void 0,void 0,function*(){x++;try{yield this.consumeSeatReservation(f,u,_),console.info(`[Colyseus devMode]: ${String.fromCodePoint(9989)} Successfully re-established connection with room '${m.roomId}'`)}catch{x<T?(console.info(`[Colyseus devMode]: ${String.fromCodePoint(128260)} retrying... (${x} out of ${T})`),setTimeout(R,2e3)):console.info(`[Colyseus devMode]: ${String.fromCodePoint(10060)} Failed to reconnect. Is your server running? Please check server logs.`)}});setTimeout(R,2e3)})),_,f,this.http.headers),new Promise((x,T)=>{const R=(S,I)=>T(new e.ServerError(S,I));_.onError.once(R),_.onJoin.once(()=>{_.onError.remove(R),x(_)})})})}createMatchMakeRequest(f,u){return n.__awaiter(this,arguments,void 0,function*(p,m,v={},_,x){const T=(yield this.http.post(`matchmake/${p}/${m}`,{headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(v)})).data;if(T.error)throw new a(T.error,T.code);return p==="reconnect"&&(T.reconnectionToken=v.reconnectionToken),yield this.consumeSeatReservation(T,_,x)})}createRoom(f,u){return new t.Room(f,u)}buildEndpoint(f,u={},p="ws"){let m=this.settings.searchParams||"";this.http.authToken&&(u._authToken=this.http.authToken);for(const x in u)u.hasOwnProperty(x)&&(m+=(m?"&":"")+`${x}=${u[x]}`);p==="h3"&&(p="http");let v=this.settings.secure?`${p}s://`:`${p}://`;f.publicAddress?v+=`${f.publicAddress}`:v+=`${this.settings.hostname}${this.getEndpointPort()}${this.settings.pathname}`;const _=`${v}/${f.processId}/${f.roomId}?${m}`;return this.urlBuilder?this.urlBuilder(new URL(_)):_}getHttpEndpoint(f=""){const u=f.startsWith("/")?f:`/${f}`;let p=`${this.settings.secure?"https":"http"}://${this.settings.hostname}${this.getEndpointPort()}${this.settings.pathname}${u}`;return this.settings.searchParams&&(p+=`?${this.settings.searchParams}`),this.urlBuilder?this.urlBuilder(new URL(p)):p}getEndpointPort(){return this.settings.port!==80&&this.settings.port!==443?`:${this.settings.port}`:""}};return l.VERSION="0.16.22",cl.Client=l,cl.MatchMakeError=a,cl}var Yf={},P0;function E2(){if(P0)return Yf;P0=1;let n=class{setState(t){}getState(){return null}patch(t){}teardown(){}handshake(t){}};return Yf.NoneSerializer=n,Yf}var I0;function b2(){return I0||(I0=1,(function(n){gC();var e=M2(),t=Z_(),i=gx(),r=_x(),s=Dc(),o=Q_(),a=E2(),c=j_();c.registerSerializer("schema",o.SchemaSerializer),c.registerSerializer("none",a.NoneSerializer),n.Client=e.Client,n.MatchMakeError=e.MatchMakeError,Object.defineProperty(n,"ErrorCode",{enumerable:!0,get:function(){return t.ErrorCode}}),Object.defineProperty(n,"Protocol",{enumerable:!0,get:function(){return t.Protocol}}),n.Room=i.Room,n.Auth=r.Auth,n.ServerError=s.ServerError,n.SchemaSerializer=o.SchemaSerializer,n.getStateCallbacks=o.getStateCallbacks,n.registerSerializer=c.registerSerializer})(Of)),Of}var w2=b2();const T2="wss://cargo-skies.fly.dev",A2=1e4,D0=n=>Promise.race([n,new Promise((e,t)=>setTimeout(()=>t(new Error("Connection timed out — a firewall or network may be blocking the game server")),A2))]);async function R2(n,e){const t=new w2.Client(T2),i=e===null?await D0(t.create("race",{nickname:n,code:H1()})):await D0(t.join("race",{nickname:n,code:e.toUpperCase()}));return{room:i,sessionId:i.sessionId,isHost:()=>i.state.hostSessionId===i.sessionId,sendInput:r=>i.send("input",r),start:()=>i.send("start",{}),setOptions:r=>i.send("options",r)}}const xx="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(11,16,38,.85);color:#fff;font:16px system-ui;z-index:10",vx="background:#141b3d;padding:28px 32px;border-radius:16px;min-width:320px;display:flex;flex-direction:column;gap:12px",Yo="padding:10px 16px;border:none;border-radius:10px;background:#e84d3d;color:#fff;font:600 16px system-ui;cursor:pointer";let nn=null,Th="";const C2=["Turbo","Dizzy","Maverick","Rusty","Comet","Waffles","Captain","Sparky","Loopy","Nimbus","Rocket","Biggles","Zippy","Sunny","Baron","Peanut"],P2=["Falcon","Pigeon","Skywolf","Albatross","Sparrow","Goose","Nugget","Thunder","Vapor","Jetstream","Swift","Puffin","Kestrel","Biplane"],I2=()=>{const n=e=>e[Math.floor(Math.random()*e.length)];return`${n(C2)} ${n(P2)}`.slice(0,16)},D2=()=>["localhost","127.0.0.1"].includes(location.hostname)||!0;function L2(n,e){const t=D2(),i=t?"":"disabled";nn=document.createElement("div"),nn.style.cssText=xx;const r=document.createElement("div");if(r.style.cssText=vx,r.innerHTML=`
    ...
    <button id="practice" style="${Yo};background:#2fbf71">Practice (solo) — no server needed</button>`,nn.appendChild(r),document.body.appendChild(nn),!t){const h=r.querySelector("#mp");h.style.opacity="0.35";for(const f of h.querySelectorAll("button, input"))f.style.cursor="not-allowed"}const s=r.querySelector("#nick");s.value=I2(),s.addEventListener("focus",()=>s.select());const o=r.querySelector("#code"),a=new URLSearchParams(location.search).get("r");a&&/^[A-Za-z0-9]{4}$/.test(a)&&(o.value=a.toUpperCase());const c=r.querySelector("#create"),l=r.querySelector("#join");c.addEventListener("click",()=>{Ah(!0,"create"),n(s.value||"Pilot",null)}),l.addEventListener("click",()=>{if(o.value.length!==4){alert("Enter the 4-letter room code from your friend's share link.");return}Ah(!0,"join"),n(s.value||"Pilot",o.value)}),r.querySelector("#practice").addEventListener("click",()=>{e()})}const N2="flex:1;padding:8px 4px;border:none;border-radius:8px;font:600 13px system-ui;cursor:pointer;color:#fff",L0=(n,e,t)=>`<div data-${n} style="display:flex;gap:6px">${e.map(i=>`<button data-v="${i}" style="${N2};background:${i===t?"#e84d3d":"rgba(255,255,255,.12)"}">${i}</button>`).join("")}</div>`;function O2(n,e,t,i){var f;nn||(nn=document.createElement("div"),nn.style.cssText=xx,document.body.appendChild(nn));const r=n.hostSessionId===e,s=[];n.players.forEach(u=>s.push(u.nickname));const o=s.length>=2,a=[n.code,s.join(","),n.legCount,n.difficulty,r].join("|");if(a===Th)return;Th=a;const c=`${location.origin}${location.pathname}?r=${n.code}`,l=`≈ ${n.legCount*2} min`,h=r?`
    ...
    </div>`,(f=nn.querySelector("#go"))==null||f.addEventListener("click",t);for(const u of nn.querySelectorAll("[data-legs] button"))u.addEventListener("click",()=>i({legCount:Number(u.dataset.v)}));for(const u of nn.querySelectorAll("[data-diff] button"))u.addEventListener("click",()=>i({difficulty:u.dataset.v??"normal"}))}function Ah(n,e="join"){const t=nn==null?void 0:nn.querySelector("#create"),i=nn==null?void 0:nn.querySelector("#join");!t||!i||(t.disabled=n,i.disabled=n,t.style.opacity=n?"0.6":"1",i.style.opacity=n?"0.6":"1",t.textContent=n&&e==="create"?"Starting…":"Start a race",i.textContent=n&&e==="join"?"Joining…":"Join a race")}function N0(){nn==null||nn.remove(),nn=null,Th=""}const U2="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(11,16,38,.85);color:#fff;font:16px system-ui;z-index:10",F2="background:#141b3d;padding:28px 32px;border-radius:16px;min-width:360px;display:flex;flex-direction:column;gap:14px",ml="padding:10px 16px;border:none;border-radius:10px;background:#2fbf71;color:#fff;font:600 16px system-ui;cursor:pointer",Uo="flex:1;padding:8px 4px;border:none;border-radius:8px;font:600 13px system-ui;cursor:pointer";let Si=null;function B2(n,e){Si==null||Si.remove(),Si=document.createElement("div"),Si.style.cssText=U2;const t=document.createElement("div");t.style.cssText=F2;const i=Object.keys(Us).map(u=>`<button data-plane="${u}" title="${Us[u].blurb}" style="${Uo}">${Us[u].emoji}<br>${Us[u].name}</button>`).join("");t.innerHTML=`
    ...
    <div style="display:flex;gap:8px">
      ...
      </tr>`}).join(""),o=i!==null?n.totalS<=i?'<div style="color:#2fbf71;font-weight:700">🎉 New best time!</div>':`<div style="opacity:.8">Best: ${Cl(i)}</div>`:"",a=document.createElement("div");a.style.cssText=$2,a.innerHTML=`
    ...
    </div>`,document.body.appendChild(ai),ai.querySelector("[data-close]").addEventListener("click",()=>{ai==null||ai.remove(),ai=null})}const Rh=.1,Mx=(n,e,t)=>`cargoSkies.trial.v3.${n}.${e}.${t}`,Z2=(n,e)=>n.charCodeAt(0)*7919+e*104729>>>0;function B0(n,e,t){try{const i=localStorage.getItem(Mx(n,e,t));return i?JSON.parse(i):null}catch{return null}}function j2(n,e,t,i){localStorage.setItem(Mx(n,e,t),JSON.stringify(i))}const z0=n=>new $(n.x,n.y,n.z);function J2(n){const e=_c(16777215);e.traverse(i=>{i instanceof St&&i.material instanceof Or&&(i.material=i.material.clone(),i.material.transparent=!0,i.material.opacity=.35)}),e.visible=!1,n.add(e);let t=[];return{start(i){t=i,e.visible=t.length>0},stop(){t=[],e.visible=!1},update(i){if(t.length===0)return;const r=i/Rh,s=Math.min(t.length-1,Math.floor(r)),o=t[Math.min(t.length-1,s+1)],a=t[s],c=Math.min(1,r-s),l=a.lat+(o.lat-a.lat)*c,h=(o.lon-a.lon+540)%360-180,f=(a.lon+h*c+540)%360-180,u=a.altKm+(o.altKm-a.altKm)*c,p=z0($n(l,f,u)),m=Gu(l,f,a.headingDeg,5);e.position.copy(p),e.up.copy(p.clone().normalize()),e.lookAt(z0($n(m.lat,m.lon,u)))}}}const Q2=34,eP=.004;function tP(){const n=new gn,e=new js({color:dR,gradientMap:fa(),transparent:!0,opacity:.92});for(let t=0;t<Q2;t++){const i=new gn,r=3+Math.floor(Math.random()*3);for(let l=0;l<r;l++){const h=1.2+Math.random()*1.6,f=new St(new Xi(h,10,8),e);f.position.set((l-r/2)*1.6,(Math.random()-.5)*.6,(Math.random()-.5)*1.4),f.scale.y=.6,i.add(f)}const s=(Math.random()-.5)*140,o=Math.random()*360-180,a=260+Math.random()*160,c=$n(s,o,a);i.position.set(c.x,c.y,c.z),i.lookAt(0,0,0),n.add(i)}return{group:n,update(t){n.rotation.y+=eP*t}}}const nP=12,iP=30,rP=.8,sP=1.2;function oP(n,e){const t=Math.max(0,n),i=nP+e*rP,r=iP+e*sP;return t<=i?1:t>=r?0:1-(t-i)/(r-i)}const Ei=Math.PI/180,Wo=512,Pl=96,aP=5,lP=26,cP=.7,fP="#24365e",uP="rgba(255,255,255,0.85)";function hP(n){const e=document.createElement("canvas");e.width=Wo,e.height=Pl;const t=e.getContext("2d");if(!t)throw new Error("2d canvas unavailable");let i=56;const r=()=>{t.font=`bold ${i}px 'Trebuchet MS', Verdana, sans-serif`};for(r();t.measureText(n).width>Wo-24&&i>18;)i-=4,r();t.textAlign="center",t.textBaseline="middle",t.lineWidth=8,t.lineJoin="round",t.strokeStyle=uP,t.strokeText(n,Wo/2,Pl/2),t.fillStyle=fP,t.fillText(n,Wo/2,Pl/2);const s=new Xo(e);return s.anisotropy=4,s}function dP(n,e,t,i){const r=Math.max(1.5,t*Math.cos(n*Ei)*(Pl/Wo)),s=new Xi(uR,12,4,(90+e-t/2)*Ei,t*Ei,(90-n-r/2)*Ei,r*Ei),o=new ui({map:i,transparent:!0,opacity:0,depthWrite:!1});return new St(s,o)}function pP(n){const e=new gn,t=[];for(const r of n.features){if(r.properties.id==="ATA")continue;const s=B1(r.geometry),o=Math.min(lP,Math.max(aP,s.widthDeg*cP)),a=dP(s.lat,s.lon,o,hP(r.properties.name));a.visible=!1,e.add(a),t.push({mesh:a,widthDeg:o,direction:new $(Math.cos(s.lat*Ei)*Math.sin(s.lon*Ei),Math.sin(s.lat*Ei),Math.cos(s.lat*Ei)*Math.cos(s.lon*Ei))})}const i=new $;return{group:e,update(r){i.copy(r.position).normalize();for(const s of t){const o=Math.acos(ng.clamp(i.dot(s.direction),-1,1))/Ei,a=oP(o,s.widthDeg);s.mesh.visible=a>.02,s.mesh.material.opacity=a}}}}const Jn=1/60,mP=.25,gP=1/20;async function _P(){const n=document.getElementById("app");if(!n)throw new Error("#app root missing");const{world:e,countries:t,landmarks:i,riddles:r}=await SR(),s=U1(e),{scene:o,camera:a,renderer:c}=yR(n),l=xR(e);o.add(l.group);const h=pP(e);o.add(h.group);const f=tP();o.add(f.group);let u=_c();o.add(u);let p=Kh,m=wg;const v=(Ae,lt=15224125)=>{o.remove(u),u=_c(lt,Ae),o.add(u),p=Us[Ae].tuning,x=Gm(u,a)},_=AR();let x=Gm(u,a);const T=zR(document.body),R=kR(o),S=HR(o),I=KR(o),A=new $(0,.2,-2.2),F=.3,M=hC(document.body),E=mC(document.body),L=G2(l),U=JR({countries:t,banner:E,hints:L,beacon:S}),z=oC(o);let C=k1();const k=Ae=>{C=Ae},P=J2(o);let B=null,N=!1,G=[],W=0,J=0;const ae=()=>{B2(me,()=>{K2(t)})},me=Ae=>{if(z2(),B=Ae,v(Ae.plane),m=Hu[Ae.speed].worldSpeedScale,N=Ae.mode==="trial",P.stop(),G=[],W=0,J=0,Ae.mode==="contract")Le.startContract({difficulty:Ae.difficulty,legCount:Ae.legCount});else if(Ae.mode==="trial"){const lt=Z2(Ae.difficulty,Ae.legCount),Ze=B0(Ae.difficulty,Ae.legCount,Ae.speed);Ze&&P.start(Ze.track),Le.startContract({difficulty:Ae.difficulty,legCount:Ae.legCount,seed:lt})}},Le=V2({countries:t,landmarks:i,riddles:r,banner:E,hints:L,beacon:S,onContractComplete:Ae=>{E.setClock(null);const lt=q2(Ae.contract.legs.map(Oe=>Oe.countryId));let Ze=null;if(N&&B){const Oe=B0(B.difficulty,B.legCount,B.speed);Ze=(Oe==null?void 0:Oe.timeS)??Ae.totalS,(!Oe||Ae.totalS<Oe.timeS)&&j2(B.difficulty,B.legCount,B.speed,{timeS:Ae.totalS,track:G}),P.stop()}X2(Ae,t,lt,Ze,{onNewContract:()=>{B&&me(B)},onMenu:ae})}}),Ne=await new Promise(Ae=>{L2((lt,Ze)=>{R2(lt,Ze).then(Ae).catch(Oe=>{console.error("Connection failed",Oe),Ah(!1);const Mt=String((Oe==null?void 0:Oe.message)??Oe),Rt=/ECONNREFUSED|failed to connect|WebSocket|network|refused|timed out/i.test(Mt);alert(Rt?"Can't reach the game server — check your internet connection (some networks/firewalls block game connections) and try again.":Ze!==null?`No race found with code ${Ze.toUpperCase()}. Check the code and try again.`:"Couldn't start a race — see the console for details.")})},()=>Ae(null))}),tt=Ne?fC(document.body,Ae=>Ne.room.send("useItem",{targetSessionId:Ae}),()=>Ne.room.send("shoot",{})):null;if(Ne&&Ne.room.onMessage("shot",Ae=>{var Mt,Rt;const lt=Ne.room.state,Ze=(Mt=lt.players)==null?void 0:Mt.get(Ae.from),Oe=Ae.hit?(Rt=lt.players)==null?void 0:Rt.get(Ae.hit):void 0;Ze&&z.flashShot(new $().copy($n(Ze.lat,Ze.lon,Ze.altKm)),Oe?new $().copy($n(Oe.lat,Oe.lon,Oe.altKm)):null)}),Ne===null)N0(),ae();else{let Ae=!1,lt=!0;Ne.room.onStateChange(Ze=>{var Mt;const Oe=(Mt=Ze.players)==null?void 0:Mt.get(Ne.sessionId);if(Oe){if(!Ae){Ae=!0,Ze.code&&history.replaceState(null,"",`?r=${Ze.code}`);const Rt=Oe.colorIdx??0;u.traverse(Bt=>{Bt instanceof St&&Bt.material instanceof js&&Bt.material.color.getHex()===15224125&&Bt.material.color.setHex(gc[Rt%gc.length]??15224125)})}Ze.phase==="lobby"&&lt?O2(Ze,Ne.sessionId,()=>Ne.start(),Rt=>Ne.setOptions(Rt)):lt&&(N0(),lt=!1),R.sync(Ze,Ne.sessionId),M.update(Ze,Ne.sessionId,()=>Ne.start()),Qo(Oe.lat,Oe.lon,C.lat,C.lon)>p1&&k({lat:Oe.lat,lon:Oe.lon,altKm:Oe.altKm,headingDeg:Oe.headingDeg,pitchDeg:Oe.pitchDeg,rollDeg:Oe.rollDeg,barrelRollS:Oe.barrelRollS,loopS:Oe.loopS,speedKmh:Oe.speedKmh})}})}let he=0,we=0,ve=0,Qe=0,nt={throttle:0,turn:0,pitch:0};const it=new ly,Xt=()=>{const Ae=Ne?jR(Ne.room.state,Ne.sessionId,C):Le.isActive()&&Le.currentLeg()?Ig(C,Le.currentLeg()):null;Ae!==null&&(C={...C,speedKmh:Ae})};c.setAnimationLoop(()=>{var lt,Ze;for(it.update(),he+=Math.min(it.getDelta(),.25);he>=Jn;)nt=_.read(Jn),C=V1(C,nt,Jn,p,m),Xt(),Le.isActive()&&(Le.update(C,Jn),N&&(J+=Jn,W+=Jn,W>=Rh&&(W-=Rh,G.push({lat:C.lat,lon:C.lon,altKm:C.altKm,headingDeg:C.headingDeg})))),he-=Jn,we+=Jn,ve+=Jn;if(Ne&&ve>=gP&&(ve=0,Ne.sendInput(nt)),we>=mP){we=0;const Oe=s.findCountryAt(C.lat,C.lon);T.setCountry(Oe?((lt=t[Oe])==null?void 0:lt.name)??Oe:null)}if(Qe+=Jn,x.update(C,nt),h.update(a),Ne){U.update(Ne.room.state,Ne.sessionId,C,Jn),tt==null||tt.update(Ne.room.state,Ne.sessionId);const Oe=(Ze=Ne.room.state.players)==null?void 0:Ze.get(Ne.sessionId);Oe&&Date.now()<Oe.tumbleUntil&&u.rotateZ(Qe*14)}z.update(Ne?Ne.room.state:null,Qe),L.update(Qe),S.update(Qe),f.update(Jn);const Ae=(C.speedKmh-Js)/(qh-Js);I.update(Jn,u.localToWorld(A.clone()),Ae>F),P.update(J),Ne&&R.update(),T.setTelemetry(C),c.render(o,a)})}_P().catch(n=>{console.error("Failed to start Cargo Skies",n),document.body.textContent="Engine stalled — please refresh."});
